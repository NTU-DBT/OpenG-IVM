-- openGauss | scenario=insertion_only | method=logical_views | scale=__SCALE__ | schema=exp_ins
\timing on
DROP SCHEMA IF EXISTS exp_ins CASCADE;
SELECT '@@JOB5@@|B|insertion_only|init_base|logical_views||0';
...
SELECT '@@JOB5@@|E|insertion_only|init_base|logical_views||0';
SELECT '@@JOB5@@|B|insertion_only|init_method|logical_views||0';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
FROM exp_ins.cfs_opt_application_t oa
...
LEFT JOIN exp_ins.tpl_fd_message_t mes
...
SELECT '@@JOB5@@|E|insertion_only|init_method|logical_views||0';
SELECT '@@JOB5@@|B|insertion_only|analyze|logical_views||0';
SET search_path = exp_ins, public;
SET query_dop = 32;
ANALYZE exp_ins.cfs_proc_node_define_t;
ANALYZE exp_ins.cfs_comm_currencies_t;
...
SELECT '@@JOB5@@|E|insertion_only|analyze|logical_views||0';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||5';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||5';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||5';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||5';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|5';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
) AS _new WHERE NOT EXISTS (SELECT 1 FROM exp_ins.dtl_lv _t WHERE _t.id = CAST(_new.id AS VARCHAR) AND _t.logical_is_deleted = _new.logical_is_deleted);
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|5';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|5';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|5';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|5';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|5';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|5';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|5';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|5';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|5';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|5';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|5';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|5';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
-- SOURCE_FILE: normal_test.sql + create_matview.sql
...
) AS _new WHERE NOT EXISTS (SELECT 1 FROM exp_ins.sum_lv _t WHERE _t.head_id = CAST(_new.head_id AS VARCHAR) AND _t.logical_is_deleted = _new.logical_is_deleted);
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|5';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|5';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|5';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|5';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|5';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|5';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|5';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|5';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|5';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|5';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|5';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||10';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||10';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||10';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||10';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|10';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|10';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|10';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|10';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|10';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|10';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|10';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|10';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|10';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|10';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|10';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|10';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|10';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|10';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|10';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|10';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|10';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|10';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|10';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|10';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|10';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|10';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|10';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|10';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||15';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||15';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||15';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||15';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|15';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|15';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|15';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|15';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|15';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|15';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|15';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|15';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|15';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|15';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|15';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|15';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|15';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|15';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|15';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|15';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|15';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|15';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|15';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|15';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|15';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|15';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|15';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|15';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||20';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||20';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||20';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||20';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|20';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|20';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|20';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|20';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|20';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|20';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|20';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|20';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|20';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|20';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|20';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|20';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|20';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|20';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|20';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|20';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|20';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|20';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|20';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|20';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|20';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|20';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|20';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|20';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||25';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||25';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||25';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||25';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|25';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|25';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|25';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|25';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|25';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|25';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|25';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|25';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|25';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|25';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|25';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|25';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|25';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|25';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|25';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|25';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|25';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|25';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|25';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|25';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|25';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|25';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|25';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|25';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||30';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||30';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||30';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||30';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|30';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|30';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|30';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|30';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|30';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|30';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|30';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|30';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|30';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|30';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|30';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|30';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|30';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|30';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|30';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|30';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|30';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|30';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|30';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|30';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|30';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|30';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|30';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|30';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||35';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||35';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||35';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||35';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|35';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|35';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|35';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|35';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|35';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|35';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|35';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|35';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|35';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|35';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|35';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|35';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|35';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|35';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|35';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|35';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|35';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|35';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|35';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|35';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|35';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|35';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|35';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|35';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||40';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||40';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||40';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||40';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|40';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|40';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|40';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|40';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|40';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|40';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|40';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|40';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|40';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|40';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|40';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|40';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|40';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|40';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|40';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|40';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|40';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|40';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|40';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|40';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|40';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|40';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|40';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|40';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||45';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||45';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||45';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||45';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|45';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|45';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|45';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|45';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|45';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|45';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|45';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|45';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|45';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|45';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|45';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|45';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|45';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|45';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|45';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|45';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|45';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|45';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|45';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|45';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|45';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|45';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|45';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|45';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||50';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||50';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||50';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||50';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|50';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|50';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|50';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|50';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|50';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|50';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|50';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|50';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|50';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|50';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|50';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|50';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|50';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|50';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|50';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|50';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|50';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|50';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|50';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|50';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|50';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|50';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|50';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|50';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||55';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||55';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||55';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||55';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|55';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|55';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|55';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|55';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|55';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|55';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|55';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|55';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|55';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|55';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|55';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|55';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|55';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|55';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|55';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|55';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|55';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|55';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|55';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|55';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|55';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|55';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|55';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|55';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||60';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||60';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||60';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||60';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|60';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|60';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|60';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|60';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|60';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|60';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|60';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|60';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|60';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|60';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|60';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|60';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|60';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|60';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|60';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|60';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|60';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|60';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|60';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|60';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|60';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|60';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|60';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|60';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||65';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||65';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||65';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||65';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|65';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|65';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|65';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|65';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|65';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|65';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|65';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|65';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|65';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|65';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|65';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|65';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|65';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|65';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|65';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|65';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|65';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|65';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|65';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|65';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|65';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|65';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|65';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|65';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||70';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||70';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||70';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||70';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|70';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|70';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|70';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|70';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|70';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|70';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|70';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|70';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|70';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|70';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|70';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|70';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|70';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|70';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|70';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|70';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|70';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|70';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|70';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|70';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|70';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|70';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|70';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|70';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||75';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||75';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||75';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||75';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|75';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|75';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|75';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|75';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|75';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|75';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|75';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|75';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|75';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|75';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|75';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|75';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|75';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|75';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|75';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|75';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|75';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|75';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|75';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|75';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|75';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|75';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|75';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|75';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||80';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||80';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||80';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||80';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|80';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|80';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|80';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|80';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|80';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|80';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|80';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|80';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|80';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|80';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|80';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|80';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|80';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|80';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|80';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|80';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|80';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|80';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|80';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|80';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|80';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|80';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|80';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|80';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||85';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||85';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||85';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||85';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|85';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|85';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|85';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|85';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|85';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|85';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|85';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|85';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|85';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|85';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|85';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|85';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|85';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|85';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|85';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|85';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|85';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|85';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|85';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|85';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|85';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|85';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|85';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|85';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||90';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||90';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||90';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||90';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|90';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|90';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|90';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|90';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|90';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|90';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|90';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|90';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|90';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|90';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|90';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|90';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|90';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|90';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|90';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|90';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|90';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|90';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|90';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|90';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|90';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|90';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|90';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|90';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||95';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||95';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||95';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||95';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|95';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|95';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|95';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|95';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|95';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|95';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|95';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|95';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|95';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|95';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|95';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|95';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|95';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|95';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|95';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|95';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|95';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|95';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|95';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|95';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|95';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|95';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|95';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|95';
SELECT '@@JOB5@@|B|insertion_only|staging|logical_views||100';
SET search_path = exp_ins, public;
SET query_dop = 32;
...
SELECT '@@JOB5@@|E|insertion_only|staging|logical_views||100';
SELECT '@@JOB5@@|B|insertion_only|base_insert|logical_views||100';
SET search_path = exp_ins, public;
SET query_dop = 32;
INSERT INTO exp_ins.cfs_cfg_company_t SELECT * FROM exp_ins.mlog_ins_company;
INSERT INTO exp_ins.cfs_cinv_customer_invoice_t SELECT * FROM exp_ins.mlog_ins_cinv;
...
INSERT INTO exp_ins.tpl_user_t SELECT * FROM exp_ins.mlog_ins_user;
INSERT INTO exp_ins.cfs_comm_contract_t SELECT * FROM exp_ins.mlog_ins_contract;
SELECT '@@JOB5@@|E|insertion_only|base_insert|logical_views||100';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q1|100';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q1|100';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q1|100';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q1|100';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q1|100';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q1|100';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q2|100';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.dtl_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q2|100';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q2|100';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q2|100';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q2|100';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(id), MAX(id), MIN(application_code), MAX(application_code), MIN(submit_date), MAX(submit_date), MIN(total_amount), MAX(total_amount) FROM exp_ins.dtl_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q2|100';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q3|100';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q3|100';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q3|100';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q3|100';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q3|100';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q3|100';
SELECT '@@JOB5@@|B|insertion_only|query|logical_views|q4|100';
SET search_path = exp_ins, public;
SET query_dop = 32;
SET enable_nestloop = off;
INSERT INTO exp_ins.sum_lv
...
SELECT '@@JOB5@@|E|insertion_only|query|logical_views|q4|100';
SELECT '@@JOB5@@|B|insertion_only|count|logical_views|q4|100';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT COUNT(*) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|count|logical_views|q4|100';
SELECT '@@JOB5@@|B|insertion_only|minmax|logical_views|q4|100';
SET search_path = exp_ins, public;
SET query_dop = 32;
SELECT MIN(head_id), MAX(head_id), MIN(total_amount), MAX(total_amount) FROM exp_ins.sum_lv;
SELECT '@@JOB5@@|E|insertion_only|minmax|logical_views|q4|100';
