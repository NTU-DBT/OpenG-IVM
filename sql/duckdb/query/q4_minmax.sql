...
-- QUERY_FORM: minmax
-- TRANSFORMATIONS: removed INSERT target; reads named views or materialized tables; dialect adaptation
SELECT MIN(q.head_id) AS min_head_id, MAX(q.head_id) AS max_head_id
FROM (
SELECT
