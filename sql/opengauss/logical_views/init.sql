...
CREATE OR REPLACE VIEW tmp_zx_send_countersign_t_mv AS
...
CREATE OR REPLACE VIEW apt_mv AS
...
CREATE OR REPLACE VIEW tmp_cfs_opt_application_inst_t_mv AS
...
CREATE OR REPLACE VIEW approval_temp_mv AS
...
CREATE OR REPLACE VIEW temp_mv AS
...
CREATE OR REPLACE VIEW send_temp_mv AS
SELECT oa.application_inst_id AS id, CAST(oa.operator_application_id AS VARCHAR) AS head_id,
    oa.application_code,
    CAST(to_char(oa.applicant_time, 'yyyyMM') AS INTEGER) AS period_id,
    CAST(to_char(oa.applicant_time, 'yyyyMMdd') AS INTEGER) AS period_id_dd,
...
CREATE OR REPLACE VIEW tic_mv AS
...
CREATE OR REPLACE VIEW countersign_temp_mv AS
SELECT oa.application_inst_id AS id, CAST(oa.operator_application_id AS VARCHAR) AS head_id,
    oa.application_code,
    CAST(to_char(oa.applicant_time, 'yyyyMM') AS INTEGER) AS period_id,
    CAST(to_char(oa.applicant_time, 'yyyyMMdd') AS INTEGER) AS period_id_dd,
...
CREATE OR REPLACE VIEW fact_t_mv AS
